  ...
  try {
    ...
    const timeline = [
      ...
      },
      {
        ...
        completed: ['Placed', 'Processing', 'Shipped', 'Delivered'].includes(order.orderStatus)
      },
      {
        status: 'Processing',
        timestamp: ['Processing', 'Shipped', 'Delivered'].includes(order.orderStatus)
      ...
      {
        status: 'Shipped',
        timestamp: ['Shipped', 'Delivered'].includes(order.orderStatus)
          ? new Date(order.createdAt).toLocaleString('en-US', {
              year: 'numeric',
              month: 'long',
              day: 'numeric',
      ...
      },
      {
        ...
        timestamp: order.orderStatus === 'Delivered'
          ? new Date(order.createdAt).toLocaleString('en-US', {
              year: 'numeric',
              month: 'long',
              day: 'numeric',
